...
#### Team's Solution
Build and train a Convolutional Neural Network to detect if images of skin show signs of cancer. [View Project Website Here](https://devpost.com/software/ml-diagnose)
